...
<blockquote style="margin-bottom:10px;background-color:#f8f9fa;padding:5px 10px">
    <code style="display:inline-block;"><a href="https://api.futemaxlive.com/api/search?token={!! $token !!}" target="_blank">https://api.futemaxlive.com/api/search?token={!! $token !!}</a></code>
...
<blockquote style="margin-bottom:10px;background-color:#f8f9fa;padding:5px 10px">
    <code style="display:inline-block;"><a href="https://api.futemaxlive.com/api/search?token={!! $token !!}&title=терминатор" target="_blank">https://api.futemaxlive.com/api/search?token={!! $token !!}&title=терминатор</a></code>
    <pre class="html-syntax">
{
    "prev": null,
    "result": [
...
<blockquote style="background-color:#f8f9fa;padding:5px 10px">
    <code style="display:inline-block;"><a href="https://api.futemaxlive.com/api/search?token={!! $token !!}&kinopoisk_id=319" target="_blank">https://api.futemaxlive.com/api/search?token={!! $token !!}&kinopoisk_id=319</a></code>
    <pre class="html-syntax">
{
    "prev": null,
    "result": [
