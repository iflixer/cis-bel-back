...
<blockquote style="margin-bottom:10px;background-color:#f8f9fa;padding:5px 10px">
    ...
    <div style="margin-bottom:5px">
        <ul style="padding-left: 0;">
            <li style="margin-top: 7px;">Изменен домен api</li>
        </ul>
    </div>
</blockquote>
...
<blockquote style="margin-bottom:10px;background-color:#f8f9fa;padding:5px 10px">
    ...
    <div style="margin-bottom:5px">
        <ul style="padding-left: 0;">
            ...
            <li style="margin-top: 7px;">Переработана логика массового проставления данных</li>
            <li style="margin-top: 7px;">Скрипт <code>actualize.js</code> автоматически подключается на страницах с нашим плеером</li>
            <li style="margin-top: 7px;">Небольшие дополнения в интерфейсе для лучшего интуитивного восприятия</li>
        </ul>
    </div>
</blockquote>