...
<table class="table">
    ...
    <tbody>
        <tr>
            ...
            <td><a href="https://api.futemaxlive.com/api/search?token={!! $token !!}" target="_blank">https://api.futemaxlive.com/api/search?token={!! $token !!}</a></td>
        </tr>
        <tr>
            ...
            <td><a href="https://api.futemaxlive.com/api/translations?token={!! $token !!}" target="_blank">https://api.futemaxlive.com/api/translations?token={!! $token !!}</a></td>
        </tr>
        <tr>
            ...
            <td><a href="https://api.futemaxlive.com/api/updates?token={!! $token !!}" target="_blank">https://api.futemaxlive.com/api/updates?token={!! $token !!}</a></td>
        </tr>
    </tbody>
</table>