...
<table class="table">
    ...
    <tbody>
        <tr>
            ...
            <td><a href="https://api.cdnhubstream.pro/api/search?token={!! $token !!}" target="_blank">https://api.cdnhubstream.pro/api/search?token={!! $token !!}</a></td>
        </tr>
        <tr>
            ...
            <td><a href="https://api.cdnhubstream.pro/api/translations?token={!! $token !!}" target="_blank">https://api.cdnhubstream.pro/api/translations?token={!! $token !!}</a></td>
        </tr>
        <tr>
            ...
            <td><a href="https://api.cdnhubstream.pro/api/updates?token={!! $token !!}" target="_blank">https://api.cdnhubstream.pro/api/updates?token={!! $token !!}</a></td>
        </tr>
    </tbody>
</table>