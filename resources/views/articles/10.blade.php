...
<blockquote style="background-color:#f8f9fa;padding:5px 10px">
    <code style="display:inline-block;"><a href="https://api.futemaxlive.com/api/updates?token={!! $token !!}" target="_blank">https://api.futemaxlive.com/api/updates?token={!! $token !!}</a></code>
    <pre class="html-syntax">
{
    "result": {
        "movies": [
