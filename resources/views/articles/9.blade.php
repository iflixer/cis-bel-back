...
<blockquote style="background-color:#f8f9fa;padding:5px 10px">
    <code style="display:inline-block;"><a href="https://futmax.info/api/translations?token={!! $token !!}" target="_blank">https://futmax.info/api/translations?token={!! $token !!}</a></code>
