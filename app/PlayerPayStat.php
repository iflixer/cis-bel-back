...
class PlayerPayStat extends Model
{
    protected $table = 'player_pay_stats';
    ...
    public static function createOrUpdateStat($date, $domainId, $geoGroupId, $watchPrice, $counter)
    {
