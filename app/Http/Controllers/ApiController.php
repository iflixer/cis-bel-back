    ...
    */
    ...
    protected function getVideo(){
        ...
        foreach ($video as $value){
            ...
            if ($element['img']) $element['img'] = "https://sss.cdnhub.help/".$element['id']."/".md5($element['img']);
            if ($element['backdrop']) $element['backdrop'] = "https://sss.cdnhub.help/".$element['id']."/".md5($element['backdrop']);
